...
export const checkboxKitTokenToAntdToken = {
    ...
    colorPrimary: `var(${kitCheckboxCssTokens.colors.background.check}, var(${utilitiesCssTokens.main.mainColor}))`,
    colorPrimaryHover: `var(${kitCheckboxCssTokens.colors.background.hover}, var(${utilitiesCssTokens.main.mainDark}))`
};
