...
For each token, there are two ways to use it :
    - `Theme token key` : Use it to define your custom theme. You can consume it in your component by using `useKitTheme` hook
    - `Css variable`, use it in your css when you create your own component and want it to use the design system tokens
