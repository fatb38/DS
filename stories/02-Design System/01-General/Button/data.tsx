...
export const ButtonArgTypes = {
    ...
    type: {
        ...
        control: { type: "select" },
        description:
            "Can be set to `primary` | `link` | `default` | `segmented`",
        table: {
            type: {
                summary: "string",
            },
    ...
    isActiveSegmented: {
        ...
        control: { type: "boolean" },
        description:
            "[Only for segmented type] - Option to display segmented button with an active state",
        table: {
            type: {
                summary: "boolean",
            },
    ...
    isCheckedSegmented: {
        ...
        control: { type: "boolean" },
        description:
            "[Only for segmented type] - Option to display segmented button with a check icon",
        table: {
            type: {
                summary: "boolean",
            },
    ...
    bigIcon: {
        ...
        control: { type: "boolean" },
        description:
            "[Only with KitSpace.Compact] Option to display only a big icon without padings in button",
        table: {
            type: {
                summary: "boolean",
            },
