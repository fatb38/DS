...
export const argTypes = {
    ...
    actions: {
        ...
        control: { type: "boolean" },
        description:
            "Display Actions buttons and / of Selects. (KitButton|KitSelect)[]",
        table: {
            type: {
                summary: "boolean",
            },
    ...
    onPlusClick: {
        name: "onPlusClick",
        description:
            "When set, show a '+' button on the right, and set the handler to handle `click` event",
        control: { type: "boolean" },
        table: {
            type: {
