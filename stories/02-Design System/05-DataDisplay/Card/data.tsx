...
export const CardArgTypes = {
    ...
    picture: {
        name: "picture",
        description:
            "Set the picure area content. Can e one of `Image` `Avatar` or `Icon`",
    ...
    onSelectChange: {
        name: "onSelectChange",
        description:
            "The callback function that is triggered when the state change. When set makes Card selectable",
        control: {
            type: "boolean",
        },
        table: {
