...
import { useModal } from 'antd';
import { KitButton } from "@kit/General/";
import { KitCheckbox, KitSelect } from '@kit/DataEntry/';
import { ModalArgTypes, Template } from "./data";
  ...
  return (
    <KitSpace direction="vertical">
      <KitSpace>
        ...
        ]} labelOnly style={{width:'120px'}} defaultValue={modalType} onChange={(value) => setModalType(value)}/>
