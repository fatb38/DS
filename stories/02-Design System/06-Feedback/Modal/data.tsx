...
export const ModalArgTypes = {
    ...
    portalClassName: {
        ...
        description:
            "String className to be applied to the portal. See the `Styles` section for more details.",
        table: {
            type: {
                summary: "string",
            },
    ...
    overlayClassName: {
        ...
        description:
            "String className to be applied to the overlay. See the `Styles` section for more details.",
        table: {
            type: {
                summary: "string",
            },
    ...
    className: {
        name: "className",
        description:
            "String className to be applied to the modal content. See the `Styles` section for more details.",
        table: {
            type: {
                summary: "string",
            },
    ...
    data: {
        name: "data",
        description:
            'Additional data attributes (optional). `{name: value]`. expmple : `{background: "green"}`',
        table: {
            type: {
                summary: "-",
            },
    ...
    testId: {
        name: "testId",
        description:
            "String testId that renders a data-testid attribute in the DOM, useful for testing",
        table: {
            type: {
                summary: "-",
            },
