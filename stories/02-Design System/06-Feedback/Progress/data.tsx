...
export const ProgressArgTypes = {
    ...
    strokeColor: {
        name: "strokeColor",
        description:
            "The color of progress bar. See each type for details about the possible values",
        control: {
            type: "text",
        },
        table: {
    ...
    circleStrokeColor: {
        name: "strokeColor",
        description:
            "The color of circular progress, render `linear-gradient` when passing an object",
        table: {
            type: {
