...
<CustomCanvas content={Examples.Basic} source={Sources.Basic} id="snackbar-basic" />

##### Closable

To show close button.

<CustomCanvas content={Examples.Closable} source={Sources.Closable} id="snackbar-closable" />

##### With a CTA

To show call to action button.

<CustomCanvas content={Examples.CallToAction} source={Sources.CallToAction} id="snackbar-cta" />
